...
import { objectList } from "../../services/mongo"


export default function ObjectList({ defCategory }) {
    ...
    async function fetchList() {
        const newList = await objectList({ category: objectCategory })
        setList(newList)
    }
